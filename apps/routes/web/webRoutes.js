...
router
    ...
    .post('/save-answer/:test_id?/:test_type?', checkAuth, Web.saveAnswer)
    .post('/save-answer-offline/:test_id?/:test_type?', checkAuth, Web.saveAnswerOffline)
    .post('/save-answer-upload/:test_type?', checkAuth, Web.saveUploadAnswer)
