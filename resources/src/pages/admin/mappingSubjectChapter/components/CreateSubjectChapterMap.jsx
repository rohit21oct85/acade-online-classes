...
export default function CreateSubjectChapterMap() {
      ...
      const saveChapters = async (e) => {
            ...
            //       if(document.querySelector(`input[name=chapter_no${key}]`) !== null){
            //             console.log(document.querySelector(`input[name=chapter_no${key}]`).value)
            //             console.log(document.querySelector(`input[name=chapter_name${key}]`).value)
            //       }
            //       arrayData.push({
                              ...
                              <span key={i}>
                                    <div className="form-group">
                                          <input 
                                                ...
                                                // value={params?.subject_chapter_id ? SingleSubjectChapter?.chapter_no : formData?.chapter_no}
                                    ...
                                    <div className="form-group">
                                          <input 
                                                ...
                                                // value={params?.subject_chapter_id ? SingleSubjectChapter?.chapter_name : formData?.chapter_name}
