      ...
      return (
            <div className="flex no-gutter" style={{ flexDirection: 'row', flexWrap: 'wrap', height: '500px', overflow: 'hidden scroll'}}>
                 {mocktests !== undefined && Array.from(mocktests)?.map((mq,ind) => {
                       return(
                              <div className="card flex col-md-12 p-2 mb-2" style={{ 
                                    cursor: 'pointer', 
                                    flexDirection: 'row', 
                                    flexWrap: 'wrap',
                                  ...
                                  <span className="col-md-9 pl-0 text-dark">Que {ind+1}. &nbsp;{mq.question}</span>
                                  <span className={`col-md-2 ${mq.answer === 'a'? 'bg-success': 'bg-danger'}`}>
